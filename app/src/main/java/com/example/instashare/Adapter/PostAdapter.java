...
import com.example.instashare.CommentsActivity;
import com.example.instashare.FollowersActivity;
import com.example.instashare.Fragments.PostDetailFragment;
import com.example.instashare.Fragments.ProfileFragment;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        publisherInfo(holder.profile_pic, holder.username, holder.publisher, post.getPublisher());
...
//    This class is the one that holds the Views with ID
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageView profile_pic, post_image, like, comment, save, more;
