        ...
        auth.createUserWithEmailAndPassword(email, password)
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    hashMap.put("bio", "");
                    hashMap.put("imageurl","https://firebasestorage.googleapis.com/v0/b/insta-3bcba.appspot.com/o/defaultprofile.png?alt=media&token=9fa400da-2b47-4b57-b2d5-58e70f352042");
